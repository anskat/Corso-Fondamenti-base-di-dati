...
- In informatica, il termine database indica una struttura organizzata di dati. I database (o più brevemente, DB) sono archivi dove le applicazioni memorizzano i dati in modo persistente1 per poterli successivamente leggere, modificare o eliminare.
